...
const CategorySwiper: React.FC<Props> = () => {
  ...
  //         <img src="https://via.placeholder.com/640x360" alt="Slide 1" />
  //       </div>
  //       <div className="swiper-slide">
  //         <img src="https://via.placeholder.com/640x360" alt="Slide 2" />
  //       </div>
  //       <div className="swiper-slide">
  //         <img src="https://via.placeholder.com/640x360" alt="Slide 3" />
  //       </div> */}
  //     </S.SwiperWrapper>
