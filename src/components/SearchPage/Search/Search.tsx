...
import {SearchContainer, SearchContainerTop, SearchEventPeriod,SearchContainerBottom,DepartmentStoreCategory, ItemCategory, SearchInput, FilterTypes, StartingDate,SelectDate, StoreContainer, PosterImg, StoreTitle, EventPeriod,EtcCategory,FilterResult } from './style';
...
const Search:any = () => {
  ...
  return (
    <SearchContainer>
      <SearchContainerTop>
        <SearchInput type="text" value={searchTerm}placeholder="키워드를 입력해주세요. (예. 서울, 액세서리)" onChange={(event) => setSearchTerm(event.target.value)} onKeyPress={startFilter}/>
